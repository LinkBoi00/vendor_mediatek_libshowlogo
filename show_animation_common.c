...
void init_charging_animation_ui_dimension()
{
    ...
    if ((lcm_width == 1080) && (lcm_height == 1920))
    { // Special handling for FHD
    ...
    else if ((lcm_width == 1080) && (lcm_height == 2160))
    { // Special handling for FHD+
    ...
    else if (lcm_width == 1080)
    {
        ...
        charg_anim_ui_dimen.num_left = 470;
        charg_anim_ui_dimen.num_right = 470 + 45;
        charg_anim_ui_dimen.percent_left = 470 + 90;
        charg_anim_ui_dimen.percent_right = 470 + 90 + 57;
        ...
        else if (lcm_height == 2300)
        {
            ...
            charg_anim_ui_dimen.cap_top = 1014;
            charg_anim_ui_dimen.cap_bottom = 1434;
            charg_anim_ui_dimen.num_top = 737;
            charg_anim_ui_dimen.num_bottom = 737 + 64;
            charg_anim_ui_dimen.percent_top = 737;
            charg_anim_ui_dimen.percent_bottom = 737 + 64;
            charg_anim_ui_dimen.top_anim_top = 100;
            charg_anim_ui_dimen.top_anim_bottom = 147;
        }
        ...
        {
            SLOGD("[show_animation_common: %s %d]Inside 1080*2400 \n", __FUNCTION__, __LINE__);
            charg_anim_ui_dimen.cap_top = 1062;
            charg_anim_ui_dimen.cap_bottom = 1483;
        ...
        else if (lcm_height == 2408) {
         SLOGD("[show_animation_common: %s %d]Inside 1080*2408 \n",__FUNCTION__,__LINE__);
         charg_anim_ui_dimen.cap_top= 1072;
         charg_anim_ui_dimen.cap_bottom= 1563 ;
         charg_anim_ui_dimen.num_top=749;
         charg_anim_ui_dimen.num_bottom=749+64;
         charg_anim_ui_dimen.percent_top=749;
         charg_anim_ui_dimen.percent_bottom=749+64;
         charg_anim_ui_dimen.top_anim_top=100;
         charg_anim_ui_dimen.top_anim_bottom=147;
        }
    ...
    else if ((lcm_width == 720) && (lcm_height == 1600))
    {
        SLOGD("[show_animation_common: %s %d]Inside 720*1600 \n", __FUNCTION__, __LINE__);
        charg_anim_ui_dimen.cap_left = 270;
        charg_anim_ui_dimen.cap_right = 450;
        ...
        charg_anim_ui_dimen.top_anim_left = 270;
        charg_anim_ui_dimen.top_anim_right = 450;
        ...
        // dynamic position for hd+ values, if more resolutions will come add nested if...else from here
        // if(lcm_height == 1600){ }  <== like this
        charg_anim_ui_dimen.cap_top = 707;
        charg_anim_ui_dimen.cap_bottom = 995;
        ...
        charg_anim_ui_dimen.top_anim_top = 100;
        charg_anim_ui_dimen.top_anim_bottom = 132;
    }
    ...
    else if (lcm_width == 1440 && lcm_height == 3216)
    {
        SLOGD("[show_animation_common: %s %d]Inside 1440*3216 \n", __FUNCTION__, __LINE__);
        charg_anim_ui_dimen.cap_left = 538;
        charg_anim_ui_dimen.cap_top = 1421;
        charg_anim_ui_dimen.cap_right = 900;
        charg_anim_ui_dimen.cap_bottom = 1996;
        charg_anim_ui_dimen.num_left = 600;
        charg_anim_ui_dimen.num_top = 1042;
        charg_anim_ui_dimen.num_right = 600 + 45;
        charg_anim_ui_dimen.num_bottom = 1042 + 64;
        charg_anim_ui_dimen.percent_left = 600 + 90;
        charg_anim_ui_dimen.percent_top = 1042;
        charg_anim_ui_dimen.percent_right = 600 + 90 + 57;
        charg_anim_ui_dimen.percent_bottom = 1042 + 64;
        charg_anim_ui_dimen.top_anim_left = 538;
        charg_anim_ui_dimen.top_anim_top = 100;
        charg_anim_ui_dimen.top_anim_right = 900;
        charg_anim_ui_dimen.top_anim_bottom = 147;
        charg_anim_ui_dimen.bar_left = 640;
        charg_anim_ui_dimen.bar_top = 1353;
        charg_anim_ui_dimen.bar_right = 801;
        charg_anim_ui_dimen.bar_bottom = 1383;
    }
    ...
    else if (lcm_width == 1200 && lcm_height == 2000)
    {
        SLOGD("[show_animation_common: %s %d]Inside 1200*2000 \n", __FUNCTION__, __LINE__);
        charg_anim_ui_dimen.cap_left = 447;
        charg_anim_ui_dimen.cap_top = 835;
        charg_anim_ui_dimen.cap_right = 751;
        charg_anim_ui_dimen.cap_bottom = 1342;
        charg_anim_ui_dimen.num_left = 494;
        charg_anim_ui_dimen.num_top = 469;
        charg_anim_ui_dimen.num_right = 578;
        charg_anim_ui_dimen.num_bottom = 590;
        charg_anim_ui_dimen.percent_left = 662;
        charg_anim_ui_dimen.percent_top = 469;
        charg_anim_ui_dimen.percent_right = 770;
        charg_anim_ui_dimen.percent_bottom = 590;
...
void fill_animation_battery_fast_charging(int capacity, void *fill_addr, void *dec_logo_addr, void *logo_addr, LCM_SCREEN_T phical_screen, int draw_anim_mode)
{
    ...
    num_width = charg_anim_ui_dimen.num_width_fast;          //LOGO_NUM_WIDTH(display_width);
    num_height = charg_anim_ui_dimen.num_height_fast;        //LOGO_NUM_HEIGHT(display_height);
    top_margin_height = charg_anim_ui_dimen.top_margin_fast; //LOGO_TOP_MARGIN(display_height);
    if (MTK_LOG_ENABLE == 1)
    {
